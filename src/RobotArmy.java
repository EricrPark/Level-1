public class RobotArmy {
	public static void main(String[] asd){
		...
		Human human = new Human("Sarampueallkadflkj;asljk");
		//2. create a new Robot army of good and evil robots.
		Robot robot = new Robot("Trazsdalkflask", true);
		Robot goodRobot = new Robot("DFKJLayadfakldsjf", false);
		//3. command your robot army to destroy a human
		robot.destroy(human);
		goodRobot.destroy(human);
	}
}
