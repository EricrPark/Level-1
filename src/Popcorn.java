/* Your mission if you have to accept it:
...
public class Popcorn {
	public static void main(String[] args) {
		Microwave macrowave = new Microwave();
		Popcorn xX1337Xx = new Popcorn("Macrowave");
		macrowave.putInMicrowave(xX1337Xx);
		macrowave.setTime(5);
		macrowave.startMicrowave();
	}
